...
// fe_port.h — FasterEdge MCU 平台移植层（PY32F002A (Cortex-M0+) 版）
// 平台相关能力在此抽象：UART 收发、EEPROM 存储、系统时间、
// 随机数、GPIO 引脚控制、芯片信息。PY32F002A 无网络，不提供 WiFi/TCP。
...
// ============================================================
// 持久化存储（PY32F002A 无硬件 EEPROM；默认返回不可用）
// ============================================================
...
// 当前固件是否配置了可写持久化后端；默认 PY32F002A 端口返回 FALSE。
u8 fe_port_persistence_available(void);
...
// ============================================================
// GPIO——逻辑 0..7=PA0..7，8..15=PB0..7，16..17=PF0..1；封装可能不引出全部引脚
// ============================================================
